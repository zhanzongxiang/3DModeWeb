-- Incremental script for platform admin governance (user/role/org)
-- Execute this script on existing databases that were created before Phase 9.
...
ALTER TABLE sys_user
  ...
  ADD COLUMN IF NOT EXISTS mobile_verified TINYINT NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS email_verified TINYINT NOT NULL DEFAULT 0,
  ...
  ADD COLUMN IF NOT EXISTS cancel_time DATETIME NULL,
