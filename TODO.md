...
- [x] **31. 基础种子数据脚本**: 生成超级管理员账号、基础角色、默认授权关系初始化 SQL。

## Phase 9: Forum Baseline（模型论坛基础能力补全）
- [x] **32. 账号安全增强**: 实现找回密码、修改密码、邮箱/手机验证、账号注销接口与页面。
- [ ] **33. 评论系统后端**: 新增评论/回复数据表与 API，支持删除与分页查询。
- [ ] **34. 评论系统前端**: 在模型详情页接入评论区、回复交互、@提醒入口。
- [ ] **35. 通知中心后端**: 新增通知表与通知投递逻辑（评论、收藏、审核、系统通知）。
- [ ] **36. 通知中心前端**: 新增通知列表页与未读数提示，支持已读/全已读。
- [ ] **37. 举报与审核流**: 新增举报入口、审核后台、违规下架与封禁动作。
- [ ] **38. 下载闭环能力**: 落地下载记录、下载计数、失效链接巡检。
- [ ] **39. 标签与检索增强**: 新增标签模型、排序规则、筛选器与接口。
- [ ] **40. 话题帖子模块**: 新增论坛帖子发布、列表、详情、回复。
- [ ] **41. 模型版本管理**: 支持版本号、更新日志、历史版本列表。
- [ ] **42. 用户主页能力**: 展示用户发布、收藏、关注关系与基础统计。
- [ ] **43. 评分体系**: 支持模型评分、评分统计、评分排序。
- [ ] **44. 增长体系**: 积分等级、榜单能力与推荐位策略。
- [ ] **45. 运营看板**: 新增核心指标统计接口与后台看板页面。
